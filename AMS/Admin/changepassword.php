...
<div class="container-fluid">
	...
	<div id="wide">
		...
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id="myBtn" type="submit" name="submit" value="SUBMIT">
		</form>
		</div>
	</div>
		...
		if(isset($_POST['submit']))
		{
			...
			$old_pass="select password from adminlogin where username='$login'";
			...
			if($password==$OldPassword)
			{
				...
				$query="update adminlogin set Password='$NewPassword' where username='$login'";
		...
		if(isset($_POST['user']))
		{
			...
			$old_pass="select * from adminlogin where username='$login'";
			$result=mysqli_query($connection,$old_pass);
			$row=mysqli_fetch_assoc($result);
			$username=$row['username'];
			if($old==$username)
			{
				$query="update adminlogin set username='$new' where username='$login'";
				mysqli_query($connection,$query);
